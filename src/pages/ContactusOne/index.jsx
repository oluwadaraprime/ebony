  ...
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-spacegrotesk items-center justify-start mx-auto w-full">
        <div className="sm:h-[1288px] md:h-[1592px] h-[1994px] md:px-5 relative w-full">
          <div className="md:h-[1160px] h-[1994px] m-auto w-full">
            <div className="absolute h-[1028px] md:h-[642px] right-[0] top-[0] w-[55%] md:w-full">
              ...
              <Img
                src="images/img_ellipse37_642x533.png"
            ...
            <Img
              src="images/img_frame882.png"
              className="absolute bottom-[0] h-[1160px] inset-x-[0] mx-auto object-cover w-full"
              alt="frame882"
            />
          </div>
          <div className="absolute bottom-[14%] flex flex-col md:gap-10 gap-[89px] inset-x-[0] justify-start mx-auto w-[81%]">
            <div className="flex md:flex-col flex-row gap-1.5 items-end justify-start md:ml-[0] ml-[250px] w-[52%] md:w-full">
              <Img
                src="images/img_mail.svg"
                className="h-7 md:mt-0 mt-[105px] w-auto"
                alt="mail"
              />
              <div className="flex flex-col gap-[30px] h-[134px] md:h-auto items-center justify-start w-[567px] sm:w-full">
                <Text
                ...
                <div className="flex sm:flex-col flex-row font-mulish gap-[22px] items-start justify-between w-full">
                  <Text
                    className="font-bold sm:mt-0 mt-[3px] text-center text-white_A700 w-auto"
                    variant="body4"
                  >
                    contact@ebonytechnology.co.uk
                  </Text>
                  <div className="flex sm:flex-1 flex-row items-start justify-evenly w-auto sm:w-full">
                    <Img
