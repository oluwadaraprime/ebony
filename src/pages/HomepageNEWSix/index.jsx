    ...
    <>
      <div className="bg-gray_900 flex flex-col font-spacegrotesk sm:gap-10 md:gap-10 gap-[81px] items-center justify-start mx-auto w-full">
        <div className="sm:h-[2630px] md:h-[2708px] h-[3566px] md:px-5 relative w-full">
          <div className="sm:h-[2630px] md:h-[2708px] h-[3566px] m-auto w-full">
            <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
              <div className="flex flex-col md:gap-10 gap-[1133px] items-end justify-start w-full">
                <div className="h-[1028px] md:h-[642px] relative w-[55%] md:w-full">
                  ...
                  <Img
                    src="images/img_ellipse37_14.png"
                        ...
                        <div className="flex md:flex-1 flex-col gap-4 items-start justify-start self-stretch w-auto md:w-full">
                          ...
                          <div className="flex flex-col font-avenirnext gap-8 items-start justify-start self-stretch w-auto md:w-full">
                            <Text
                              ...
                              variant="body3"
                            >
                              We are a UK tech company creating digital
                              solutions that support businesses and
                              organisations across the world to launch, run and
                              grow. We achieve this by working closely with our
                              clients to understand, not assume their
                              requirements. We then combine this information
                              with business intelligence to turn our clients’
            ...
            <MainHomepageStackhappyguytwo
              className="absolute font-inter h-[736px] right-[8%] top-[4%] w-[57%] md:w-full"
          ...
          <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto pb-[43px] top-[0] w-full">
            <div className="flex flex-col md:gap-10 gap-[136px] items-center justify-start w-full">
              <AnimatedStartingHomepageHeader
                className="border border-blue_100 border-solid flex flex-row flex-wrap items-center justify-between max-w-[1439px] md:px-10 sm:px-5 px-[100px] py-[19px] w-full"
              ...
              <div className="flex flex-col items-start justify-start w-[82%] md:w-full">
                <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start w-[97%] md:w-full">
                  <Text
                    className="leading-[126.00%] text-left text-white_A700 w-1/2 sm:w-full"
                    as="h4"
                    variant="h4"
                  >
                  ...
                  <Img
                    ...
                    className="h-[41px] mb-[99px] md:ml-[0] ml-[114px] md:mt-0 mt-[31px] w-auto"
                    alt="checkmark"
                  />
                  <Img
                    src="images/img_trash.svg"
                    className="h-[59px] md:ml-[0] ml-[348px] md:mt-0 mt-28 w-[59px]"
                    alt="trash"
                  />
                </div>
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[26px] w-full">
                  <Text
                    className="font-normal leading-[160.00%] not-italic text-left text-white_A700 w-auto"
                    variant="body4"
                  >
                    At Ebony Technology, we create digital solutions that
                    support businesses to launch, run and grow.
                  </Text>
                  <div className="flex md:flex-1 flex-col font-inter items-center justify-start md:mt-0 mt-[45px] w-auto md:w-full">
                    <div className="bg-white_A700 flex flex-col items-center justify-end p-2.5 rounded-[10px] w-full">
                      <div className="flex flex-col items-center justify-start mt-[5px] w-[96%] md:w-full">
                        <div className="flex flex-col gap-[5px] items-start justify-start w-full">
                          <Text
                            className="font-medium text-blue_gray_300 text-left w-auto"
                            variant="body7"
                          >
                            Total Project
                          </Text>
                ...
                <Button
                  className="capitalize cursor-pointer font-medium leading-[normal] min-w-[193px] mt-[25px] text-2xl md:text-[22px] text-center text-gray_900_01 sm:text-xl w-auto"
                ...
                <Button
                  className="flex h-12 items-center justify-center md:ml-[0] ml-[778px] mt-[69px] rotate-[-15deg] w-12"
...
export default HomepageNEWSixPage;
