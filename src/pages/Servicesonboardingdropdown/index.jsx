...
import ServicesOnboardingDropdownImplementanime from "components/ServicesOnboardingDropdownImplementanime";
import ServicesOneColumn from "components/ServicesOneColumn";

const ServicesonboardingdropdownPage = () => {
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-spacegrotesk gap-[45px] items-center justify-start mx-auto w-full">
        ...
        <div className="flex flex-col font-avenirnext md:px-5 relative w-full">
          ...
          <div className="bg-white_A700 flex flex-col font-spacegrotesk items-center justify-start mt-[-1px] mx-auto p-[118px] md:px-10 sm:px-5 w-full z-[1]">
            <div className="flex md:flex-col flex-row md:gap-10 gap-[78px] items-center justify-start self-stretch w-auto md:w-full">
              ...
              <div className="flex flex-col gap-6 items-start justify-start self-stretch w-auto sm:w-full">
                ...
                <ServicesOnboardingDropdownImplementanime
                  className="flex flex-col gap-4 items-end justify-start self-stretch w-auto sm:w-full"
                  customerrelatioOne="Customer Relationship Management"
                  accountingandinOne="Accounting and invoicing software"
                  humanresources="Human Resources (HR) solutions"
                  workforceremoteOne="Workforce remote monitoring"
                  healthcaremanagOne="Healthcare Management Solutions"
                  businessreportiOne="Business Reporting and Data Analytics"
                  projectmanagemeOne="Project management and collaboration tools"
...
export default ServicesonboardingdropdownPage;
