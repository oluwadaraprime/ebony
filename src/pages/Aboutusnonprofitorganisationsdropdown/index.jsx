...
import AboutUsNonProfitOrganisationsDropDownColumnourclientsThree from "components/AboutUsNonProfitOrganisationsDropDownColumnourclientsThree";
import AnimatedStartingHomepageFooternew from "components/AnimatedStartingHomepageFooternew";

const AboutusnonprofitorganisationsdropdownPage = () => {
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-spacegrotesk items-center justify-start mx-auto w-full">
        <div className="md:h-[1511px] h-[1779px] sm:h-[958px] md:px-5 relative w-full">
          <div className="absolute h-[1119px] md:h-[642px] right-[0] top-[0] w-[83%] md:w-full">
            <div className="absolute bottom-[0] md:h-[634px] h-[892px] inset-x-[0] mx-auto w-full">
              <Img
            ...
            <Img
              src="images/img_ellipse37_10.png"
              className="absolute h-[642px] object-cover right-[0] top-[0] w-[45%]"
          ...
          />
          <div className="absolute flex flex-col gap-2 items-center justify-start left-[35%] top-[22%] w-[16%]">
            <Text
        ...
        <div className="bg-gray_50 flex flex-col items-center justify-start p-[79px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col md:gap-10 gap-20 items-center justify-start max-w-[1116px] mb-[47px] mx-auto self-stretch w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 gap-[68px] items-center justify-start self-stretch w-auto md:w-full">
              ...
              <AboutUsNonProfitOrganisationsDropDownColumnourclientsThree
...
export default AboutusnonprofitorganisationsdropdownPage;
