...
const HomepageNEWFivePage = () => {
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-spacegrotesk sm:gap-10 md:gap-10 gap-[81px] items-center justify-end mx-auto pt-[808px] w-full">
        <div className="sm:h-[2101px] md:h-[2185px] h-[2758px] md:px-5 relative w-full">
          <div className="absolute bg-lime_50 bottom-[20%] flex flex-col inset-x-[0] items-center justify-start mx-auto pt-[76px] w-full">
          ...
          <div className="absolute bg-gray_50 flex flex-col font-spacegrotesk gap-[41px] inset-x-[0] justify-start mx-auto sm:pl-5 pl-8 py-8 top-[0] w-full">
            <Img
...
export default HomepageNEWFivePage;
