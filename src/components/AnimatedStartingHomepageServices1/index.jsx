...
const AnimatedStartingHomepageServices1 = (props) => {
  return (
    <>
        ...
        <div className="bg-gray_400 flex flex-col items-center justify-start rounded-[20px] w-full">
          <div className="h-[328px] relative w-full">
            ...
            <div className="absolute bg-gradient  flex flex-col h-full inset-[0] items-start justify-center m-auto p-4 rounded-[20px] w-full">
              <Button
                className="capitalize cursor-pointer font-bold font-spacegrotesk leading-[normal] min-w-[182px] ml-1 md:ml-[0] mt-[248px] text-base text-center text-gray_900_01 w-auto"
...
AnimatedStartingHomepageServices1.defaultProps = {
  digitalMarketing: "Digital Marketing",
};

export default AnimatedStartingHomepageServices1;
