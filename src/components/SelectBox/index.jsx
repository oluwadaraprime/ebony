        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#f6f6f6",
              "&:hover": { backgroundColor: "#f6f6f6", color: "#2e2e2e" },
            }),
...
SelectBox.propTypes = {
  ...
  shape: PropTypes.oneOf(["RoundedBorder12", "RoundedBorder16"]),
  variant: PropTypes.oneOf(["FillBluegray900", "OutlineBluegray200"]),
