...
const AboutUsEducationalInstituteDropdownColumnourclientsThree = (props) => {
  return (
    <>
...
AboutUsEducationalInstituteDropdownColumnourclientsThree.defaultProps = {
...
export default AboutUsEducationalInstituteDropdownColumnourclientsThree;
